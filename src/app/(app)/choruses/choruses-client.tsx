...
import { addChorusItemAction, removeChorusItemAction } from "./actions";
        ...
        {sortedItems.length === 0 ? (
          ...
          sortedItems.map((item, i) => (
            ...
            >
              ...
              <button
                type="button"
                onClick={() => startTransition(() => removeChorusItemAction(item.id))}
                aria-label="Remove chorus"
